...
function ContactsThree() {
  return (
      <div className='h-[750px] mt-500 relative top-24 mt-12 border rounded-xl'>
        ...
        <nav className="space-y-1">
          ...
          <div className="py-4">
            <Link to="/all-saved-views" className="flex items-center justify-between py-2 text-blue-500 font-medium">
              All Saved Views
              <img src="https://i.ibb.co/CwNM9rM/ooui-next-ltr.png" alt="Chevron right" className="w-4 h-4" />
            </Link>
          </div>
        </nav>
      </div>
