            ...
            <table className="w-full divide-y divide-gray-200 border-collapse">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="w-[200px] px-4 py-3 text-left text-sm font-semibold text-gray-900 border-r border-gray-300">
                    Name
                  </th>
                  <th scope="col" className="w-[250px] px-4 py-3 text-left text-sm font-semibold text-gray-900 border-r border-gray-300">
                    Email
                  </th>
                  <th scope="col" className="w-[200px] px-4 py-3 text-left text-sm font-semibold text-gray-900 border-r border-gray-300">
                    Job Title
                  ...
                  <th scope="col" className="w-[150px] px-4 py-3 text-left text-sm font-semibold text-gray-900">
                    Source
                  </th>
                </tr>
              </thead>
                  ...
                  <tr key={user.id}>
                    ...
                    <td className="whitespace-nowrap px-4 py-3 border-r border-gray-300">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-gray-900 mr-6">{user.name}</span>
                      </div>
                    </td>
                    <td className="whitespace-nowrap px-4 py-3 border-r border-gray-300">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-sm ${user.email === 'Not found' ? 'text-gray-500' : 'text-gray-900'}`}>
                          {user.email}
                        </span>
                      </div>
                    </td>
