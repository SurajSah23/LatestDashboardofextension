...
function DashboardFour() {
  ...
  return (
    <div className="shadow-xl border border-gray-200 sm:w-[590px] md:w-[768px] lg:w-[870px] rounded-lg ml-4 sm:ml-6 sm:mt-8 md:mt-12 lg:relative lg:bottom-96 lg:-translate-y-96 lg:shadow-lg lg:-mt-28">
