...
function DashboardThree() {
  return (
    <div className="sm:w-[326px] sm:h-[586px] sm:mr-64 mt-4 mr-2 rounded-[20px] border border-gray-200 space-y-6 lg:translate-x-12 shadow-lg">
      {/* Profile Section */}
      ...
      <div className="space-y-2 px-4">
        ...
        <div className="flex items-center bg-blue-50 p-3 rounded-xl">
          <img
            ...
            alt="Credit Card"
            className="h-15 ml-2 p-2 sm:h-16"
          />
          <div className="flex-1">
            ...
            <div className="w-full sm:w-[213px] bg-gray-100 rounded-full h-1.5 relative right-3 bottom-6 ml-2">
